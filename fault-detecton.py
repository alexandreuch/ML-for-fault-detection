...
def main():
    folder_path = '/home/pingulino/Alexandre/ML-for-fault-detection/segmented_database_1_v3/'
    
    audio_inst,audio_class_list = audio_samples_and_classes(folder_path)
    
    corte = int(len(audio_inst)*0.7)

    X_test = audio_inst[corte:]
    Y_test = audio_class_list[corte:]
    
    X_Default_test = audio_inst[:corte]
    Y_Default_test = audio_class_list[:corte]
